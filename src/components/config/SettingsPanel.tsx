  ...
  return (
    <div className="space-y-6">
      <ConfigForm form={form} onSubmit={onSubmit}>
        <ConfigSection
          title="Media Paths"
          description="Configure where your movies and TV shows are located."
        >
        ...
        <ConfigSection
          ...
          description="Configure Gemini AI and Vertex API."
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
        ...
        <ConfigSection
          ...
          description="Configure video resolution and quality."
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input
                type="number"
                {...form.register('video.targetWidth', { valueAsNumber: true })}
              />
            </div>
            <div className="space-y-2">
              ...
              <Input
                type="number"
                {...form.register('video.targetHeight', { valueAsNumber: true })}
              />
            </div>
            <div className="space-y-2">
        ...
        <div className="flex justify-end gap-3 pt-4 border-t border-white/5">
          {unsavedChanges && (
            <span className="text-sm text-yellow-500 self-center">Unsaved changes</span>
          )}

...
describe("LogViewer", () => {
  const mockLogs = [
    { timestamp: new Date("2025-01-01T10:00:00"), level: "info" as const, message: "Starting pipeline" },
    { timestamp: new Date("2025-01-01T10:00:01"), level: "info" as const, message: "Analyzing video" },
    { timestamp: new Date("2025-01-01T10:00:02"), level: "warn" as const, message: "Low memory" },
    { timestamp: new Date("2025-01-01T10:00:03"), level: "error" as const, message: "Failed to process" },
  ];

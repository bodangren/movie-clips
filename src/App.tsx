...
const VideoPreview = lazy(() => import("./components/pipeline/VideoPreview").then(m => ({ default: m.VideoPreview })));
          ...
          <div className="space-y-8 animate-fade-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="glass p-6 rounded-xl border-glow">
                ...
                <p className="text-sm text-muted-foreground mb-4">Library scan completed. {libraryItems.length} titles indexed.</p>
                <button 
              ...
              <div className="glass p-6 rounded-xl border-glow">
                ...
                <p className="text-sm text-muted-foreground mb-4">All services operational. GPU acceleration active.</p>
                <button 
        ...
        return (
          <div className="space-y-6 animate-fade-in">
            ...
            <div className="max-w-4xl mx-auto glass rounded-2xl overflow-hidden border-glow-primary p-4 min-h-[400px]">
              <ErrorBoundary fallback={() => <div className="p-4 text-red-500">Failed to load preview engine</div>}>
                <Suspense fallback={<div className="w-full h-full flex items-center justify-center text-muted-foreground">Loading preview engine...</div>}>
                  <VideoPreview />
                </Suspense>
              </ErrorBoundary>
            </div>
